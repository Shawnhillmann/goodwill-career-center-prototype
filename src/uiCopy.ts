...
const uiStrings: Record<SupportedLanguage, UiStrings> = {
  en: {
    ...
    placeholder: 'Start typing here or click the microphone to talk.',
    addFile: 'Add file',
  ...
  es: {
    ...
    placeholder: 'Empieza a escribir aquí o haz clic en el micrófono para hablar.',
  ...
  it: {
    ...
    placeholder: 'Inizia a scrivere qui o fai clic sul microfono per parlare.',
  ...
  ht: {
    ...
    placeholder: 'Kòmanse ekri isit la oswa klike sou mikwofòn nan pou pale.',
  ...
  pl: {
    ...
    placeholder: 'Zacznij pisać tutaj lub kliknij mikrofon, aby mówić.',
    addFile: 'Dodaj plik',
  ...
  ru: {
    ...
    placeholder: 'Начните вводить текст здесь или нажмите микрофон, чтобы говорить.',
  ...
  ar: {
    ...
    placeholder: 'ابدأ الكتابة هنا أو انقر على الميكروفون للتحدث.',
    addFile: 'إضافة ملف',
