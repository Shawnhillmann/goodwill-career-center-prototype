...
/** Mobile carousel: resume first, then remaining actions. */
export const MOBILE_QUICK_ACTION_ORDER: QuickActionId[] = [
  'build_resume',
  'explore_careers',
  'help_apply',
  'practice_interviews',
...
const quickActionCopy: Record<SupportedLanguage, Record<QuickActionId, QuickActionCopy>> = {
  en: {
    ...
    help_apply: {
      label: 'Help Me Apply',
      description: 'Guidance on job search and applications',
    ...
    practice_interviews: {
      ...
      description: 'Prepare and practice for interviews',
    ...
    career_plan: {
      ...
      description: 'Outline goals and next steps',
    ...
    local_resources: {
      ...
      description: 'Career support near you',
  ...
  es: {
    explore_careers: {
      ...
      description: 'Descubre profesiones que pueden encajar contigo',
    ...
    build_resume: {
      label: 'Armar mi CV',
      description: 'Crea o mejora tu currículum',
    ...
    help_apply: {
      ...
      description: 'Orientación para buscar trabajo y aplicar',
    ...
    practice_interviews: {
      ...
      description: 'Prepárate y practica para entrevistas',
    ...
    career_plan: {
      label: 'Planificación',
      description: 'Define metas y próximos pasos',
    ...
    local_resources: {
      ...
      description: 'Apoyo profesional cerca de ti',
  ...
  it: {
    explore_careers: {
      ...
      description: 'Scopri professioni adatte a te',
    ...
    build_resume: {
      ...
      description: 'Crea o migliora il tuo curriculum',
    ...
    help_apply: {
      ...
      description: 'Guida per cercare lavoro e candidarsi',
    ...
    practice_interviews: {
      label: 'Prep. colloqui',
      description: 'Preparati e allenati per i colloqui',
    ...
    career_plan: {
      ...
      description: 'Definisci obiettivi e passi di carriera',
    ...
    local_resources: {
      ...
      description: 'Supporto professionale vicino a te',
  ...
  ht: {
    explore_careers: {
      ...
      description: 'Dekouvri pwofesyon ki ka adapte avèk ou',
    ...
    build_resume: {
      ...
      description: 'Kreye oswa amelyore rezime ou',
    ...
    help_apply: {
      label: 'Ede m aplike',
      description: 'Gid pou chèche travay ak aplike',
    ...
    practice_interviews: {
      label: 'Prep. entèvyou',
      description: 'Prepare epi pratike pou entèvyou',
    ...
    career_plan: {
      label: 'Planifikasyon',
      description: 'Defini objektif ak pwochen etap',
    ...
    local_resources: {
      label: 'Resous lokal',
      description: 'Sipò karyè tou pre ou',
  ...
  pl: {
    explore_careers: {
      ...
      description: 'Odkryj zawody, które mogą Ci pasować',
    ...
    build_resume: {
      ...
      description: 'Utwórz lub ulepsz swoje CV',
    ...
    help_apply: {
      ...
      description: 'Wskazówki dotyczące poszukiwania pracy i aplikacji',
    ...
    practice_interviews: {
      label: 'Prep. rozmów',
      description: 'Przygotuj się do rozmów kwalifikacyjnych',
    ...
    career_plan: {
      ...
      description: 'Określ cele i kolejne kroki',
    ...
    local_resources: {
      ...
      description: 'Wsparcie zawodowe w pobliżu',
  ...
  ru: {
    explore_careers: {
      ...
      description: 'Найти подходящие профессии',
    ...
    build_resume: {
      ...
      description: 'Создать или улучшить резюме',
    ...
    practice_interviews: {
      ...
      description: 'Подготовка и тренировка к интервью',
    ...
    career_plan: {
      ...
      description: 'Цели и следующие шаги',
    ...
    local_resources: {
      ...
      description: 'Поддержка рядом с вами',
  ...
  ar: {
    explore_careers: {
      ...
      description: 'اكتشف مهنًا قد تناسبك',
    ...
    build_resume: {
      label: 'بناء سيرتي',
      description: 'إنشاء سيرتك أو تحسينها',
    ...
    help_apply: {
      ...
      description: 'إرشاد للبحث عن عمل والتقديم',
    ...
    practice_interviews: {
      ...
      description: 'الاستعداد والتمرين للمقابلات',
    ...
    career_plan: {
      ...
      description: 'تحديد الأهداف والخطوات التالية',
...
export function listMobileQuickActions(language: SupportedLanguage): Array<QuickActionCopy & { id: QuickActionId }> {
  return MOBILE_QUICK_ACTION_ORDER.map((id) => ({ id, ...getQuickActionCopy(language, id) }))
}
